document.addEventListener('DOMContentLoaded', function() {
    ...
    deal_load(nm, id, pw, phone, birth);
    console.log(nm, id, phone, birth);
});

function deal_load(nm, id, pw, phone, birth) {
    if(nm != null && id != null && pw != null)
    {
        ...
        category_deal.onclick = function() {
            location.href = `DEAL_MAIN.html?nm=${encodeURIComponent(nm)}&id=${encodeURIComponent(id)}&pw=${encodeURIComponent(pw)}&phone=${encodeURIComponent(phone)}&birth=${encodeURIComponent(birth)}`;
        };
