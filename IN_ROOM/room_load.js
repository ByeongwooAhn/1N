document.addEventListener('DOMContentLoaded', function() {
    ...
    room_load(nm, id, pw, phone, birth);
    console.log(nm, id, phone, birth);
});

function room_load(nm, id, pw, phone, birth) {
    if(nm != null && id != null && pw != null)
    {
        ...
        category_room.onclick = function() {
            location.href = `IN_ROOM.html?nm=${encodeURIComponent(nm)}&id=${encodeURIComponent(id)}&pw=${encodeURIComponent(pw)}&phone=${encodeURIComponent(phone)}&birth=${encodeURIComponent(birth)}`;
        };

        room_1.onclick = function() {
            location.href = `IN_ROOMA.html?nm=${encodeURIComponent(nm)}&id=${encodeURIComponent(id)}&pw=${encodeURIComponent(pw)}&phone=${encodeURIComponent(phone)}&birth=${encodeURIComponent(birth)}`;
        };

        room_2.onclick = function() {
            location.href = `IN_APT.html?nm=${encodeURIComponent(nm)}&id=${encodeURIComponent(id)}&pw=${encodeURIComponent(pw)}&phone=${encodeURIComponent(phone)}&birth=${encodeURIComponent(birth)}`;
        };

        room_3.onclick = function() {
            location.href = `IN_BY.html?nm=${encodeURIComponent(nm)}&id=${encodeURIComponent(id)}&pw=${encodeURIComponent(pw)}&phone=${encodeURIComponent(phone)}&birth=${encodeURIComponent(birth)}`;
        };
    }
}
