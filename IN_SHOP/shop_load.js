document.addEventListener('DOMContentLoaded', function() {
    ...
    shop_load(nm, id, pw, phone, birth);
    console.log(nm, id, phone, birth);
});

function shop_load(nm, id, pw, phone, birth) {
    if(nm != null && id != null && pw != null)
    {
        ...
        category_shop.onclick = function() {
            location.href = `shopmain.html?nm=${encodeURIComponent(nm)}&id=${encodeURIComponent(id)}&pw=${encodeURIComponent(pw)}&phone=${encodeURIComponent(phone)}&birth=${encodeURIComponent(birth)}`;
        };
